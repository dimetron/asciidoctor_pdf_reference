:title: Asciidoc Reference Guide
The Article Title
=================
Author's Name <dimetron@me.com>
v1.0, 2014-10
...
Here are a couple of image examples: an image:images/logo.png[]
example inline image followed by an example block image:

.Tiger block image
image::images/logo.png[Tiger image]
